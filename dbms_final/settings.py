"""
Django settings for dbms_final project.
...
SECRET_KEY = 'o7@k-bb!$8==4js#%2w6@&3o)&md@q%x3v9hkbqp$^(qsoc8b='
...
WSGI_APPLICATION = 'dbms_final.wsgi.application'
